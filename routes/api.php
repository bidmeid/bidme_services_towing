...
Route::group(['middleware' => 'auth:sanctum',], function () {
	...
	Route::group(['middleware' => ['auth:sanctum','role:customer']], function() {
		...
		Route::post('/updatePassword', [Api\UsersCustomer::class, 'update_password']);
		...
		Route::post('/reviewOrder', [Api\PostOrder::class, 'reviewOrder']);
	...
	Route::group(['middleware' => ['auth:sanctum','role:mitra']], function() {
		...
		Route::get('/mitra/getOrderForBidById', [Api\Mitra\Order::class, 'getOrderForBidById']); 
		...
		Route::post('/mitra/saveToken', [Api\Mitra\UsersMitra::class, 'saveToken']);
