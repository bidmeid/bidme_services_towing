                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
											...
											<p>
                                                <a href="{{ $data['to_url']}}?email={{ $data['email'] }}&token={{ $data['token'] }}">{{ $data['to_url']}}?email={{ $data['email'] }}&token={{ $data['token'] }}</a>
											</p>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <table role="presentation" border="0" cellpadding="0"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td> <a href="{{ $data['to_url']}}?email={{ $data['email'] }}&token={{ $data['token'] }}"
