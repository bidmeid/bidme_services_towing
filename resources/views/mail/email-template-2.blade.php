...
<body>
    <span class="preheader">Pemberitahuan Order Towing Masuk</span>
                        ...
                        <tr>
                            <td class="wrapper">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <h3>#Pemberitahuan Order Towing Yang Harus anda Segera Selesaikan</h3>
                                            <p>
                                                Hi, {{ $details['name'] }}
                                            </p>
                                            <p> Anda memiliki pesanan towing masuk untuk segera diselesaikan/dijalankan, berikut rincian pesanan : </p>
											<p> Penjemputan  : {{ $details['alamatAsal'] }} </p>
											<p> Tujuan  : {{ $details['alamatTujuan'] }}</p>
											<p> Nomor Invoice  : {{ $details['invoice'] }} </p>
											<p> Status Pembayaran  : {{ $details['payment'] }} </p>
											<p> Tanggal Pembayaran  : {{ $details['paymentDate'] }} </p>
											<br>
