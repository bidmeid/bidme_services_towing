...
<body>
    <span class="preheader">Pemberitahuan Order Towing Tersedia</span>
                        ...
                        <tr>
                            <td class="wrapper">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <h3>#Pemberitahuan Order Towing Tersedia Untuk Anda Bidding</h3>
                                            <p>
                                                Hi, {{ $details['name'] }}
                                            </p>
                                            <p> Ada pesanan towing dengan rincian sebagai berikut : </p>
                                            <p>
